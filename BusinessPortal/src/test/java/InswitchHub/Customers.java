...
public class Customers extends BaseTest {
    ...
    public void viewCustomers() throws IOException, InterruptedException {
        ...
        WebElement customersOption = driver.findElement(By.xpath("//span[contains(text(),'Customers')]"));
        ...
        WebElement viewCustomers = new WebDriverWait(driver, 10).until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@class='btn btn-primary']")));
        if(viewCustomers.isDisplayed()){
            ...
            String listCustomers = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[2]/table/tbody")).getText();
            System.out.println("/-------------------------------------------------------/");
        ...
        WebElement newCustomer = driver.findElement(By.xpath("//i[contains(text(),'library_add')]"));
        ...
        WebElement addCustomerType = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[2]/select"));
        if (addCustomerType.isDisplayed()) {
            addCustomerType.click();
            //Opción Natural Person
            driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[2]/select/option[1]")).click();
        ...
        WebElement customerAddDocument = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/div/div/div[1]/button"));
        ...
        WebElement customerIdType = driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div/div[1]/div/div/div[1]/select"));
        if (customerIdType.isDisplayed()) {
            customerIdType.click();
            //National ID
            driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div/div[1]/div/div/div[1]/select/option[2]")).click();
            //Passport
        ...
        WebElement customerIdNumber = driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div/div[1]/div/div/div[2]/input"));
        ...
        WebElement customerIssueDate = driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div/div[1]/div/div/div[3]/input"));
        ...
        WebElement customerExpiryDate = driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div/div[1]/div/div/div[4]/input"));
        ...
        WebElement customerIssuerPlace = driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div/div[1]/div/div/div[6]/div/select"));
        if (customerIssuerPlace.isDisplayed()) {
            customerIssuerPlace.click();
            driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div/div[1]/div/div/div[6]/div/select/option[48]")).click();
        ...
        WebElement customerConfirmAddDocument = driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]/div/div[2]/button"));
        ...
        WebElement customerInfoAddDocument = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/div/div/div[2]/div/table/tbody"));
        ...
        WebElement customerUserName = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[1]/div/div[1]/input"));
        ...
        WebElement customerTitle = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[2]/div/div[1]/input"));
        ...
        WebElement customerFirstName = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[2]/div/div[2]/input"));
        ...
        WebElement customerMiddleName = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[2]/div/div[3]/input"));
        ...
        WebElement customerLastName = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[2]/div/div[4]/input"));
        ...
        WebElement customerPhoneNumber = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[3]/div/div[1]/input"));
        ...
        WebElement customerEmailAddress = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[3]/div/div[2]/input"));
        ...
        WebElement ownerLastNamePhone = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[3]/div/div[2]/input"));
        ...
        WebElement customerDateofBirth = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[4]/div/div[1]/input"));
        ...
        WebElement customerBirthCountry = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[4]/div/div[2]/div/select"));
        if (customerBirthCountry.isDisplayed()) {
            customerBirthCountry.click();
            driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[4]/div/div[2]/div/select/option[48]")).click();
        ...
        WebElement customerGender = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[4]/div/div[3]/div/select"));
        if (customerGender.isDisplayed()) {
            customerGender.click();
            //Opcion Male
            driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[4]/div/div[3]/div/select/option[3]")).click();
            //Opción Female
        ...
        WebElement customerNationality = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[4]/div/div[4]/div/select"));
        if (customerNationality.isDisplayed()) {
            customerNationality.click();
            //Opcion Male
            driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[4]/div/div[4]/div/select/option[48]")).click();
        ...
        WebElement customerResidenceCountry = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[4]/div/div[5]/div/select"));
        action6.moveToElement(customerResidenceCountry);
        if (customerResidenceCountry.isDisplayed()) {
            customerResidenceCountry.click();
            driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[4]/div/div[5]/div/select/option[39]")).click();
        ...
        WebElement createCustomer = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div/main/div[2]/div[3]/div[2]/div/div[4]/form/div[4]/div/div[5]/div/select"));
        ...
        WebElement confirmCreateCustomer = driver.findElement(By.xpath("/html/body/div[3]/div/div/div[2]"));
